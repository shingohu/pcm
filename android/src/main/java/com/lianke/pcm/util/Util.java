...
public class Util {
     ...
     */
    public static void pcm2wav(String inPcmFilePath, String outWavFilePath, int sampleRate,
    ...
    public static void adpcmFile2wav(String inAdPcmFilePath, String outWavFilePath, int sampleRate,
        ...
        try {
            ...
            short[] pcmData = new Adpcm().decode(byteArray);

            new File(inAdPcmFilePath).deleteOnExit();


            new File(inAdPcmFilePath).createNewFile();


            FileOutputStream fileOutputStream = new FileOutputStream(inAdPcmFilePath);
            fileOutputStream.write(shortToByte(pcmData));
